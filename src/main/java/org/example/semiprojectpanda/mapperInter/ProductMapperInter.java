...
//지금 추가된 productnum 구하기
    ...
    @Select("""
            ...
            WHERE productnum = #{productnum}
            """)
    public List<Integer> getChatroomNumByProductnum(int productnum);
    ...
    @Delete("""
            ...
            """)
    public void deleteChatting(@Param("productnum") int productnum);
    ...
    @Delete("""
            ...
            """)
    public void deleteProduct(@Param("productnum") int productnum, @Param("usernum") int usernum);
